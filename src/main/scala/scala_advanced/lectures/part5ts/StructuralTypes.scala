...
object StructuralTypes extends App {
  ...
  class HipsterCloseable {
    ...
    def closeSilently(): Unit = println("not making a s sound")
  }
...
//  closeShh(new HipsterCloseable)
  ...
  class Car {
    def makeSound(): Unit = println("vroommm!!")
  }
  ...
  /*
    f is compatible with a CBL and with a Human? a: YES
   */
  ...
  /*
    HeadEqualizer is compatible with a CBL and with a Human? a: Yes
   */
