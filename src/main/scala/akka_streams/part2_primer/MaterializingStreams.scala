...
//    case Success(value) => println(s"The sum of elements is $value")
//    case Failure(e) => println(s"ex = ${e.getMessage}")
//  }
  ...
  graph.run.onComplete {
    ...
    case Failure(e) => println(s"Stream processing failed with: ${e.getMessage}")
  }
