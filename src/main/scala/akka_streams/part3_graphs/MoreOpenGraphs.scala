...
//  max3RunnableGraph.run
  ...
  val transactionSource = Source(List(
    Transaction("23423423", "Paul", "Jim", 100, new Date),
    Transaction("43654555", "Alex", "Jim", 100000, new Date),
    Transaction("19943463", "Jim", "Alice", 7000, new Date)
  ))
