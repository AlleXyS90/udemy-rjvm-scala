package akka_streams.part3_graphs

import akka.actor.ActorSystem
import akka.stream.scaladsl.GraphDSL.createGraph
...
object GraphMaterializedValues extends App {
  ...
  val complexWordSink = Sink.fromGraph(
    createGraph(printer, counter)((printerMatValue, counterMatValue) => counterMatValue) { implicit builder => (printerShape, counterShape) =>
...
//    case Failure(ex) => println(s"The count of short strings failed: ${ex.getMessage}")
//  }
